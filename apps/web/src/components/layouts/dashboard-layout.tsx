...
export function DashboardLayout({
  ...
  const [expandedSections, setExpandedSections] = useState<string[]>(["family", "personal"])
  ...
  const NavigationItemComponent = ({
    ...
    // Remove language prefix from pathname to compare with href
    const pathWithoutLocale = pathname.replace(/^\/(en-US|nl-NL)/, "")
      ...
      <div className="p-4 border-t border-border" data-testid="desktop-user-profile">
        ...
        >
          ...
          <div className="flex-1 min-w-0 text-left">
            ...
            <p className="text-xs text-muted-foreground truncate" data-testid="user-family">The Doe Family</p>
            <div className="flex items-center gap-1 mt-1">
              <Sparkles className="h-3.5 w-3.5 text-primary fill-primary" />
              <span className="text-xs font-semibold text-primary" data-testid="user-karma">{userKarma} Karma</span>
            </div>
          </div>
        </Link>
      </div>
    ...
    <div className="flex flex-col h-full" data-testid="mobile-nav-content">
      ...
      <div className="p-4 border-t border-border" data-testid="mobile-user-profile">
        ...
        >
          ...
          <div className="flex-1 min-w-0 text-left">
            <p className="text-sm font-medium truncate" data-testid="mobile-user-name">John Doe</p>
            <p className="text-xs text-muted-foreground truncate" data-testid="mobile-user-family">The Doe Family</p>
            <div className="flex items-center gap-1 mt-1">
              <Sparkles className="h-3.5 w-3.5 text-primary fill-primary" />
              <span className="text-xs font-semibold text-primary" data-testid="mobile-user-karma">{userKarma} Karma</span>
            </div>
          </div>
        </Link>
      </div>
