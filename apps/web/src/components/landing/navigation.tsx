 ...
 *
 * In standalone mode: Shows only logo and action buttons (minimal UI)
 * In SaaS mode: Shows full navigation with features, pricing, docs links
 */
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          {/* Navigation Links - Only show in SaaS mode */}
          {!isStandalone && (
          ...
          {/* Action buttons - Only show in SaaS mode */}
          {!isStandalone && (
