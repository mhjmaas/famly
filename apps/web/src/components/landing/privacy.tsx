      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-chart-2/10 border border-chart-2/20 mb-6">
            ...
            <span className="text-sm font-medium text-chart-2">{dict.badge}</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mb-16">
          {privacyFeatureCards.map(({ key, icon: Icon }) => {
            ...
            return (
              <Card key={key} className="p-6 bg-card border-2 hover:shadow-lg transition-all duration-300">
        ...
        <Card className="max-w-4xl mx-auto p-8 md:p-12 bg-gradient-to-br from-card to-secondary border-2">
          <div className="text-center space-y-6">
            ...
            <h3 className="text-2xl md:text-3xl font-bold">{dict.promise.title}</h3>
            <p
              className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed"
              dangerouslySetInnerHTML={{ __html: dict.promise.description }}
            />
            <div className="pt-4">
