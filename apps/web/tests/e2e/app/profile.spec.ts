...
test.describe("Profile Page", () => {
  ...
  test.describe("Activity Timeline", () => {
    ...
    test("should show activity events or no events message", async ({ page }) => {
  ...
  test.describe("Theme Toggle - Desktop", () => {
    ...
    test("should toggle theme from light to dark on desktop", async ({ page }) => {
      await setViewport(page, "desktop");
      await page.waitForTimeout(300);
  ...
  test.describe("Theme Toggle - Mobile/Tablet", () => {
    test("should display preferences card with theme toggle on mobile", async ({ page }) => {
    ...
    test("should display preferences card with theme toggle on tablet", async ({ page }) => {
  ...
  test.describe("Language Selector - Mobile/Tablet", () => {
    test("should display language selector in preferences card on mobile", async ({ page }) => {
      await setViewport(page, "mobile");
      await page.waitForTimeout(300);
    ...
    test("should display language selector in preferences card on tablet", async ({ page }) => {
      await setViewport(page, "tablet");
      await page.waitForTimeout(300);
  ...
  test.describe("Responsive Behavior", () => {
    test("should hide desktop preferences and show mobile card on mobile", async ({ page }) => {
      await setViewport(page, "mobile");
      await page.waitForTimeout(300);
    ...
    test("should show desktop preferences and hide mobile card on desktop", async ({ page }) => {
      await setViewport(page, "desktop");
      await page.waitForTimeout(300);
